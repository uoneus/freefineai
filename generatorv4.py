...
def print_config_info():
    ...
    print(f"   多页面: {'✅' if CONFIG['ENABLE_MULTI_PAGE'] else '❌'}")
    ...
    if CONFIG["ENABLE_MULTI_PAGE"]:
        nav_menu = '''
            <div class="hidden md:flex items-center gap-6 text-xs font-bold uppercase tracking-widest">
                <a href="index.html" class="text-zinc-400 hover:text-white transition">首页</a>
                <a href="gallery.html" class="text-zinc-400 hover:text-white transition">画廊</a>
                <a href="tools.html" class="text-zinc-400 hover:text-white transition">工具</a>
                <a href="about.html" class="text-zinc-400 hover:text-white transition">关于</a>
            </div>
        '''
...
def generate_gallery_page():
    ...
    <header class="pt-32 pb-16 px-6 text-center">
        <h1 class="text-6xl md:text-8xl font-black mb-6 leading-none hero-title text-white">画廊</h1>
        <p class="max-w-2xl mx-auto text-zinc-500 text-base font-light leading-relaxed mb-8">
            浏览我们精选的 Flux.1 AI 生成图像集合
        </p>
    </header>

    <main class="max-w-[1400px] mx-auto px-6 pb-32">
        <div class="flex flex-col md:flex-row justify-between items-end mb-8 gap-4">
            <h2 class="text-white text-2xl font-black tracking-tighter uppercase italic">全部作品</h2>
            <div class="flex gap-4 text-[10px] text-zinc-600 font-bold uppercase tracking-[0.3em]">
                <button class="hover:text-white transition">全部</button>
                <button class="hover:text-white transition">最新</button>
                <button class="hover:text-white transition">热门</button>
            </div>
        </div>
...
def generate_tools_page():
    ...
    tools_content = f'''
    <header class="pt-32 pb-16 px-6 text-center">
        <h1 class="text-6xl md:text-8xl font-black mb-6 leading-none hero-title text-white">工具箱</h1>
        <p class="max-w-2xl mx-auto text-zinc-500 text-base font-light leading-relaxed mb-8">
            专业的 AI 图像生成工具和资源
        </p>
    </header>
    ...
    <!-- 更多工具 -->
    <section class="max-w-[1400px] mx-auto px-8 mb-16">
        <h2 class="text-white text-2xl font-black tracking-tighter uppercase italic mb-8">更多工具</h2>
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-zinc-900/50 border border-white/5 p-6 rounded-3xl backdrop-blur-md">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h3 class="text-white font-black text-xs uppercase tracking-[0.2em]">图片对比</h3>
                </div>
                <p class="text-zinc-400 text-sm mb-4">拖拽两张图片进行A/B对比分析</p>
            ...
            <div class="bg-zinc-900/50 border border-white/5 p-6 rounded-3xl backdrop-blur-md">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h3 class="text-white font-black text-xs uppercase tracking-[0.2em]">颜色提取</h3>
                </div>
                <p class="text-zinc-400 text-sm mb-4">从图片中提取主色调和配色方案</p>
            ...
            <div class="bg-zinc-900/50 border border-white/5 p-6 rounded-3xl backdrop-blur-md">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h3 class="text-white font-black text-xs uppercase tracking-[0.2em]">批量下载</h3>
                </div>
                <p class="text-zinc-400 text-sm mb-4">选择多张图片打包下载</p>
...
def generate_about_page():
    ...
    about_content = f'''
    <header class="pt-32 pb-16 px-6 text-center">
        <h1 class="text-6xl md:text-8xl font-black mb-6 leading-none hero-title text-white">关于我们</h1>
        <p class="max-w-2xl mx-auto text-zinc-500 text-base font-light leading-relaxed mb-8">
            了解 FreeFineAI 的故事和使命
        </p>
    </header>
    ...
    <main class="max-w-[1400px] mx-auto px-6 pb-32">
        <div class="grid md:grid-cols-2 gap-12 mb-16">
            <div>
                <h2 class="text-3xl font-black text-white mb-6">我们的使命</h2>
                <p class="text-zinc-400 leading-relaxed mb-6">
                    FreeFineAI 致力于为全球创作者提供最高质量的 AI 生成图像资源。我们相信人工智能应该赋能每一个有创意的人，而不是成为创作的障碍。
                </p>
                <p class="text-zinc-400 leading-relaxed">
                    通过精心策划的 Flux.1 图像集合和强大的创作工具，我们帮助设计师、艺术家和创意工作者将想象变为现实。
                </p>
            </div>
            
            <div>
                <h2 class="text-3xl font-black text-white mb-6">为什么选择我们</h2>
                <div class="space-y-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h3 class="text-white font-bold mb-1">精选质量</h3>
                            <p class="text-zinc-400 text-sm">每张图片都经过人工筛选，确保最高的视觉质量</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h3 class="text-white font-bold mb-1">完全免费</h3>
                            <p class="text-zinc-400 text-sm">核心功能永久免费，支持创意民主化</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h3 class="text-white font-bold mb-1">持续更新</h3>
                            <p class="text-zinc-400 text-sm">每日新增内容，跟上 AI 技术发展步伐</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="bg-zinc-900/50 border border-white/5 rounded-3xl p-8 mb-16">
            <h2 class="text-2xl font-black text-white mb-8 text-center">平台数据</h2>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div class="text-center">
                    <div class="text-3xl font-black text-cyan-400 mb-2">1000+</div>
                    <div class="text-zinc-400 text-sm uppercase tracking-widest">精选图片</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-black text-purple-400 mb-2">50K+</div>
                    <div class="text-zinc-400 text-sm uppercase tracking-widest">总下载量</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-black text-green-400 mb-2">10K+</div>
                    <div class="text-zinc-400 text-sm uppercase tracking-widest">活跃用户</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-black text-yellow-400 mb-2">24/7</div>
                    <div class="text-zinc-400 text-sm uppercase tracking-widest">在线服务</div>
                </div>
            </div>
        </section>
        ...
        <section class="text-center">
            <h2 class="text-3xl font-black text-white mb-6">联系我们</h2>
            <p class="text-zinc-400 mb-8 max-w-2xl mx-auto">
                有问题、建议或合作意向？我们很乐意听到您的声音。
            </p>
...
def generate():
    ...
    cards_html = ""
    for img in images[:12]:  # 首页只显示前12张
        name = img.split('.')[0].replace('_', ' ').title()
        cards_html += f'''
        <div class="break-inside-avoid mb-6 relative group rounded-3xl overflow-hidden bg-zinc-900 border border-white/5 shadow-2xl transition-all duration-500 hover:border-cyan-500/50">
            <img src="images/{img}" alt="{name}" loading="lazy" class="w-full h-auto transition-transform duration-700 group-hover:scale-105">
    ...
    <main class="max-w-[1400px] mx-auto px-6 pb-32">
        <div class="flex flex-col md:flex-row justify-between items-end mb-8 gap-4">
            <h2 class="text-white text-2xl font-black tracking-tighter uppercase italic">精选作品</h2>
            <a href="gallery.html" class="text-[10px] text-zinc-600 font-bold uppercase tracking-[0.3em] hover:text-white transition">查看全部 →</a>
        </div>
        <div class="masonry">{cards_html}</div>
        ...
        <div class="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-left mb-12">
            ...
            <div>
                ...
                <ul class="space-y-3 text-xs font-bold">
                    <li><a href="index.html" class="text-zinc-600 hover:text-primary transition uppercase tracking-widest">首页</a></li>
                    <li><a href="gallery.html" class="text-zinc-600 hover:text-primary transition uppercase tracking-widest">画廊</a></li>
                    <li><a href="tools.html" class="text-zinc-600 hover:text-primary transition uppercase tracking-widest">工具</a></li>
                    <li><a href="about.html" class="text-zinc-600 hover:text-primary transition uppercase tracking-widest">关于</a></li>
                </ul>
            </div>
            <div>
...
'''
    ...
    if CONFIG["ENABLE_MULTI_PAGE"]:
        ...
        generate_tools_page()
        generate_about_page()
        print(f"📄 多页面生成: index.html, gallery.html, tools.html, about.html")
    
    print(f"🚀 优化版网站生成成功！")
    print(f"📊 包含 {len(images)} 张图片")
    print(f"✨ 语法错误已修复")
    print(f"🎨 界面优化: 间距紧凑，视觉协调")
